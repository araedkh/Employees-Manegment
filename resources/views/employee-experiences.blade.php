...
<html>
<head>
	<title> EMPLOYEE EXPERIENCES </title>
	<meta charset="utf-8">
...
<body>
  ...
  <strong><li><a class="active" href="{{route('store_Exper')}}">Experience</a></li></strong>
...
<!-- FORM TO INSERT DATA -->
<form method="post" action="{{route('store_Exper')}}">
	@method('GET')

	<div class="form-row">
		<div class="col-md-3 mb-3">
      <label>Work Place :</label><span class="error"> *</span>
      <input type="text" class="form-control" name="workPlace" required>
      </div>

      <div class="col-md-3 mb-3">
      <label>Job Title :</label><span class="error"> *</span>
      ...
      <div class="col-md-3 mb-3">
      <label>Salary :</label><span class="error"> *</span>
      <input type="text" class="form-control" name="salary" required>
      </div>

      <div class="col-md-3 mb-3">
			<label >Currency :</label><span class="error"> *</span>
